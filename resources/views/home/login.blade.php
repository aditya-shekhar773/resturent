            ...
            <div class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                ...
                <div class="md:w-8/12 lg:ml-6 lg:w-5/12">
                    <div class="w-full px-2 py-2 bg-teal-700 text-center justify-between flex text-white rounded-lg">
                        <h1 class="px-2 py-2">Normal Login</h1>
                        <h1 class="bg-orange-500 px-2 py-2 rounded-lg"><a href="{{route('home.register')}}">Registation</a></h1>
                    ...
                    <div class="w-full mt-5">
                        <a href="{{route('home.register')}}" class="bg-teal-500 px-2 py-2 rounded-lg">Registation</a>
                    </div>
                </div>
            </div>
        </div>
