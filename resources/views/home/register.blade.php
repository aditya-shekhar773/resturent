        ...
        <div class="container h-full px-6 py-24">
            <div class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                ...
                <div class="md:w-8/12 lg:ml-6 lg:w-5/12">
                    <div class="w-full px-2 py-2 bg-teal-700 text-center justify-between flex text-white rounded-lg">
                        <h1 class="px-2 py-2">Apply For Registation</h1>
                        <h1 class="bg-orange-500 px-2 py-2 rounded-lg"><a href="{{route('home.login')}}">Login</a></h1>
                    ...
                    <form method="post" action="" class="mt-5">
                        ...
                        <div class="relative mb-3" data-te-input-wrapper-init>
                            <label for="exampleFormControlInput3"
                                class=" left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary">Name
                            </label>
